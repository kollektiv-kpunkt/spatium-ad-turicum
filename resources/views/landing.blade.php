...
<x-app-layout :title="__('sat.site.masthead')">
    <div class="sat-container sat-container__md">
        ...
        <div class="sat-card my-12">
            ...
            <p class="mb-4">Die Stadtbevölkerung wächst, der Platz für sie aber nicht genug schnell. Und mitten drin lassen Liegenschafteigentümer*innen ihre Gebäude brach liegen und räumen alle kreativen Nutzungen mit irrsinnigen Ausreden. <b>Das darf nicht sein!</b> Unterzeichne unseren Brief und fordere mit uns den Stadtrat dazu auf, sich um diesen Misstand zu kümmern!</p>
            <x-form />
        </div>
