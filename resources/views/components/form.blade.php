    ...
    <div class="sat-signup-form__container">
        <div class="fdb-signup-form__inner">
            <form action="/supporters" method="POST" class="sat-form mt-6">
                ...
                <button type="submit" class="sat-button !bg-white !text-green w-full flex justify-center items-center gap-x-2 mt-2 font-bold">{{__("sat.form.submit") }}  <i class="icofont-duotone icofont-apply"></i></button>
            </form>
        </div>
    </div>
</div>
